...
export default InputTextFile.extend(ClusterDriver, {
  ...
  command: computed('labels', 'token.nodeCommand', 'etcd', 'controlplane', 'worker', 'address', 'internalAddress', function() {
    ...
    let out = 'sudo lemonc run -d --privileged --restart=unless-stopped --net=host lemon/lemonc-agent:1.0.0 --server https://39.107.110.199:10443 --token sj585dnw84ls7sz72j68xt7k8b6d8t8l88mvvwdfdmkgtqtrsc59ds --ca-checksum 955386928eedf085c0887d80e84905e3e28c4fb198b1c5078547bff258f4f637';
  ...
  value: computed('pasteOrUpload', {
    ...
    set(key, value) {
      ...
      try {
        ...
        set(this, 'clusterOptErrors', [`集群选项解析错误: ${ err.snippet } - ${ err.message }`]);
